...
// namespace api.Store
// {
//     public class AzTableTemporaStore : IOrgEntityStore<Amphora.Common.Models.Tempora>
//     {
...
//             if(string.Equals(entity?.OrgId, orgId))
//             {
//                 return entity;
//             }
//             else
...
//         public Task<IEnumerable<Tempora>> ListAsync()
//         {
