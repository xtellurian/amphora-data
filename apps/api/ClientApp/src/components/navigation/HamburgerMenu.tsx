    ...
    return (
      ...
      >
        ...
        <Nav vertical className="m-2">
          ...
          >
            <NavLink tag={Link} className="text-light" to="/amphora">
              My Amphora
            </NavLink>
          </NavItem>
          <NavItem
          ...
          >
            <NavLink tag={Link} className="text-light" to="/create">
              Create
            </NavLink>
          </NavItem>
          <NavItem
          ...
          >
            <NavLink tag={Link} className="text-light" to="/request">
              Request
            </NavLink>
          </NavItem>
          <NavItem
          ...
          >
            <NavLink tag={Link} className="text-light" to="/terms">
              Terms of Use
            </NavLink>
          </NavItem>
          <hr className="bg-white" />
