...
namespace Amphora.Infrastructure.Extensions
{
    ...
    {
        public static void AddAllPollyHttpClients(this IServiceCollection services)
        {
        ...
        public static void AddTsiHttpClient(this IServiceCollection services)
        {
            var policy = HttpPolicyExtensions
                .HandleTransientHttpError() // HttpRequestException, 5XX and 408
                .OrResult(response => (int)response.StatusCode == 429) // RetryAfter
            ...
            services.AddHttpClient(HttpClientNames.TimeSeriesInsights, client =>
            {
